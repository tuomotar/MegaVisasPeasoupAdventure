...
this.stageEnter.velocity.yPixMin):(this===a.roller&&(b=Math.floor(2*Math.random())+1,f=.2*u+1,b=2>b?-1:1),f=new d(this.stageEnter.velocity.xPixMin*f*b,this.stageEnter.velocity.yPixMin));this.velocity=f};a.spaceship.levelUp=function(){u++;a.roller.die();a.spaceship.setStartVel();a.spaceship.setStartPoint();c.score.text=u;q.slurp.audio.play()};a.roller.die=function(){a.roller.platformHitPlayed=!1;a.roller.onSurface=!1;a.roller.affectedByGravity=!1;a.roller.position.x=b.designDim.w/2;a.roller.position.y=
...
!0;a.arrowRight.visible=!0;a.arrowDown.visible=!0;a.arrowLeft.visible=!0;a.spaceship.visible=!0;a.roller.visible=!0;a.hernekeitto.visible=!0;a.roller.play();a.spaceship.velocity=new d(0,0);a.level250.setStartPoint();a.spaceship.setStartPoint();a.arrowUp.setStartPoint();a.arrowDown.setStartPoint();a.arrowLeft.setStartPoint();a.arrowRight.setStartPoint();ttAudioManager.seq.parts.part1.playing=!0;ttAudioManager.seq.parts.part2.playing=!0;u=0;q.gameStart.audio.play();l=b.GAME_STATES.GAME_ON};f.runGameFrame=
function(){tabOn&&0<e.timeDiffNowMs&&(f.doPhysicsPart1(),f.doPhysicsPart2(),a.spaceship.checkVisualAsset())};f.runMainLoop=function(){if(tabOn){var a=function(){f.loopCalculateTime();l==b.GAME_STATES.START_START_SCREEN&&f.runStartStartScreen();l==b.GAME_STATES.START_SCREEN&&f.runStartScreen();l==b.GAME_STATES.START_GAME&&f.runStartGame();l==b.GAME_STATES.GAME_ON&&f.runGameFrame();x.render(A);ttAudioManager.runSequencer();window.requestAnimationFrame(a)};a()}}})(window.ttMain=window.ttMain||{},jQuery);
(function(a,b){a.mainRenderer;a.windowDim={w:0,h:0};a.gameArea={w:0,h:0,l:0,r:0,t:0,b:0};a.designDim={w:0,h:0};a.renderObjectId="not_defined";a.scalingFactor=1;a.nonGameArea={w:0,h:0};a.initRendererDimensions=function(b,d,c,g,e,h){a.mainRenderer=b;a.designDim.w=d;a.designDim.h=c;a.renderObjectId=g;a.nonGameArea.w=e;a.nonGameArea.h=h;a.calculateRendererDimensions();a.scalingFactor=a.gameArea.w/a.designDim.w;return{w:a.gameArea.w,h:a.gameArea.h,l:a.gameArea.l,r:a.gameArea.r,t:a.gameArea.t,b:a.gameArea.b,
scalingFactor:a.scalingFactor}};a.calculateRendererDimensions=function(){a.windowDim.w=window.innerWidth;a.windowDim.h=window.innerHeight;a.gameArea.h=1<=a.windowDim.h/a.designDim.h?a.designDim.h:a.windowDim.h;a.gameArea.w=a.designDim.w/a.designDim.h*a.gameArea.h;document.getElementById(a.renderObjectId).setAttribute("style","width:"+a.gameArea.w+"px; height:"+a.gameArea.h+"px; position:absolute;");a.gameArea.l=a.windowDim.w/2-a.gameArea.w/2;a.gameArea.r=a.gameArea.l+a.gameArea.w;a.gameArea.t=0;a.gameArea.b=
a.gameArea.t+a.gameArea.h;document.getElementById(a.renderObjectId).style.left=a.gameArea.l};a.scaleRenderer=function(){a.calculateRendererDimensions();x.view.style.width=a.gameArea.w+"px";x.view.style.height=a.gameArea.h+"px"}})(window.ttScalingManager=window.ttScalingManager||{},jQuery);(function(a,b){a.seq={parts:[]};a.createAudioSequencer=function(b){for(var d in b)a.seq.parts[d]=b[d],a.seq.parts[d].soundsPlaying=[]};a.runSequencer=function(){for(var b in a.seq.parts)a.seq.parts[b].playing&&(a.seq.parts[b].counter<
a.seq.parts[b].triggerNewSoundsIntervalMS?a.seq.parts[b].counter+=e.timeDiffNowMs:(a.seq.parts[b].soundsPlaying.length<a.seq.parts[b].soundsPlayingLimit&&(q[a.seq.parts[b].data[Math.floor(Math.random()*a.seq.parts[b].data.length)].handle].audio.play(function(d){a.seq.parts[b].soundsPlaying.push(d)}).partId=b),a.seq.parts[b].counter=0))};a.loadAudios=function(b){a.assocAudiosPlaying=[];var d=0,c=0,g=[],e;for(e in b)g[b[e].handle]={},g[b[e].handle].handle=b[e].handle,c++,g[b[e].handle].audio=new Howl({urls:[b[e].path],
loop:b[e].data.loop,volume:b[e].data.volume,format:b[e].data.format}),g[b[e].handle].audio.handle=b[e].handle,g[b[e].handle].isPlaying=!1,g[b[e].handle].audio.on("play",function(){a.assocAudiosPlaying[this.handle]=!0}),g[b[e].handle].audio.on("end",function(b){a.assocAudiosPlaying[this.handle]=!1;"undefined"!=typeof a.seq.parts[this.partId]&&(b=a.seq.parts[this.partId].soundsPlaying.indexOf(b),-1<b&&a.seq.parts[this.partId].soundsPlaying.splice(b,1))}),d++;return g}})(window.ttAudioManager=window.ttAudioManager||
{},jQuery);(function(a,d){a.createText=function(a){return new PIXI.Text(a.stageEnter.text,{font:a.font.sizePx+"px "+a.font.name,dropShadow:a.font.dropShadow,dropShadowDistance:a.font.dropShadowDistance,dropShadowColor:parseInt(a.font.dropShadowColor),stroke:parseInt(a.font.strokeColor),strokeThickness:a.font.strokeThickness,fill:parseInt(a.font.fillColor),align:a.font.align})};a.createTextObjectsFromJson=function(){for(var d in b.texts)c[b.texts[d].name]=a.createText(b.texts[d]),c[b.texts[d].name].x=
b.texts[d].stageEnter.xPixMin,c[b.texts[d].name].y=b.texts[d].stageEnter.yPixMin}})(window.ttTextManager=window.ttTextManager||{},jQuery);(function(a,d){a.highScoreTexts=[];a.loadTop10=function(){var c=d.getJSON(b.urls.top10ajax+"?get_top_10=true",function(a){});c.fail(function(a){console.log("Ajax fail.")});c.done(function(b){for(var d in b)a.highScoreTexts[d]={points:b[d][1],nick:b[d][0]};a.setHighScores()})};a.setHighScores=function(){c.top10_1.text=a.highScoreTexts[0].nick+" "+a.highScoreTexts[0].points;
c.top10_2.text=a.highScoreTexts[1].nick+" "+a.highScoreTexts[1].points;c.top10_3.text=a.highScoreTexts[2].nick+" "+a.highScoreTexts[2].points;c.top10_4.text=a.highScoreTexts[3].nick+" "+a.highScoreTexts[3].points;c.top10_5.text=a.highScoreTexts[4].nick+" "+a.highScoreTexts[4].points;c.top10_6.text=a.highScoreTexts[5].nick+" "+a.highScoreTexts[5].points;c.top10_7.text=a.highScoreTexts[6].nick+" "+a.highScoreTexts[6].points;c.top10_8.text=a.highScoreTexts[7].nick+" "+a.highScoreTexts[7].points;c.top10_9.text=
a.highScoreTexts[8].nick+" "+a.highScoreTexts[8].points;c.top10_10.text=a.highScoreTexts[9].nick+" "+a.highScoreTexts[9].points;c.top10_1.x=b.designDim.w/2-c.top10_1.width/2;c.top10_2.x=b.designDim.w/2-c.top10_2.width/2;c.top10_3.x=b.designDim.w/2-c.top10_3.width/2;c.top10_4.x=b.designDim.w/2-c.top10_4.width/2;c.top10_5.x=b.designDim.w/2-c.top10_5.width/2;c.top10_6.x=b.designDim.w/2-c.top10_6.width/2;c.top10_7.x=b.designDim.w/2-c.top10_7.width/2;c.top10_8.x=b.designDim.w/2-c.top10_8.width/2;c.top10_9.x=
b.designDim.w/2-c.top10_9.width/2;c.top10_10.x=b.designDim.w/2-c.top10_10.width/2};a.saveTop10=function(d){if(d>a.highScoreTexts[9].points){for(var c=5,g="ABC";3<c&&null!=g;)g=prompt("P\u00e4\u00e4sit Top 10 -listalle. Anna nimimerkki jonka pituus on 1 - 3 merkki\u00e4.",g),null==g&&(g="ABC"),c=g.length,1>c&&(c=5);null!=g&&(d=jQuery.ajax({method:"POST",url:b.urls.top10ajax,data:{save_top_10:d,nick:g}}),d.fail(function(a){console.log("Ajax fail.")}),d.done(function(b){b=eval(b);for(var d in b)a.highScoreTexts[d]=
{points:b[d][1],nick:b[d][0]};a.setHighScores()}))}}})(window.ttHighScoreManager=window.ttHighScoreManager||{},jQuery);var D=h(37),y=h(38),C=h(39),B=h(40),J=h(87),M=h(65),K=h(83),L=h(68),N=h(85),H=h(51),I=h(52),O=h(32),t=[];N.press=O.press=function(a){l=b.GAME_STATES.START_GAME};N.release=O.release=function(a){};d.prototype.add=function(a){this.x+=a.x;this.y+=a.y};d.prototype.substract=function(a){this.x-=a.x;this.y-=a.y};d.prototype.multiply=function(a){this.x*=a;this.y*=a};d.prototype.getMagnitude=
function(){return Math.sqrt(this.x*this.x+this.y*this.y)};d.prototype.getAngle=function(){return Math.atan2(this.y,this.x)};d.fromAngle=function(a,b){return new d(b*Math.cos(a),b*Math.sin(a))};PIXI.Sprite.prototype.name="";PIXI.Sprite.prototype.acceleration=new d(0,0);PIXI.Sprite.prototype.pastAcceleration=new d(0,0);PIXI.Sprite.prototype.velocity=new d(0,0);PIXI.Sprite.prototype.pastVelocity=new d(0,0);PIXI.Sprite.prototype.pastPosition=new d(0,0);PIXI.Sprite.prototype.temporaryAccelerationImpulseX=
0;PIXI.Sprite.prototype.temporaryAccelerationImpulseY=0;PIXI.Sprite.prototype.temporaryVelocityImpulseX=0;PIXI.Sprite.prototype.temporaryVelocityImpulseY=0;PIXI.Sprite.prototype.onSurface=!1;PIXI.Sprite.prototype.affectedByGravity=!1;PIXI.Sprite.prototype.bounce=0;PIXI.Sprite.prototype.staticInCollision=!1;PIXI.Sprite.prototype.getMinVector=function(){return new d(this.position.x-this.width/2,this.position.y-this.height/2)};PIXI.Sprite.prototype.getMaxVector=function(){return new d(this.position.x+
this.width/2,this.position.y+this.height/2)};PIXI.Sprite.prototype.getSizeVector=function(){return new d(this.width,this.height)};var E,F;PIXI.Sprite.prototype.checkIfCollision=function(f){var c=!1,e;if(this===a.roller&&f===a.level250||f===a.roller&&this===a.level250)e={x:a.roller.position.x,y:a.roller.position.y,r:a.roller.width/4},c={x:a.level250.position.x-a.level250.width/2,y:a.level250.position.y-a.level250.width/2,w:a.level250.width,h:a.level250.height},!a.roller.onSurface&&P(e,c)&&(a.roller.position.y<=
a.level250.position.y-a.level250.height/2&&0<a.roller.velocity.y?a.roller.checkPlatformHit(a.level250):a.roller.onSurface||(a.roller.position.x<a.level250.position.x&&0<a.roller.velocity.x&&!top_bottom&&(a.roller.position.x=a.level250.position.x-a.level250.width/2-a.roller.width/2),a.roller.position.x>a.level250.position.x&&0>a.roller.velocity.x&&!top_bottom&&(a.roller.position.x=a.level250.position.x+a.level250.width/2+a.roller.width/2))),a.roller.onSurface&&a.roller.position.y<a.level250.position.y&&
(a.roller.position.x<a.level250.position.x-a.level250.width/2||a.roller.position.x>a.level250.position.x+a.level250.width/2)&&(a.roller.onSurface=!1);if(this===a.spaceship&&f===a.level250||f===a.spaceship&&this===a.level250)a.spaceship.onSurface&&(0<Math.abs(a.spaceship.velocity.y)&&(a.spaceship.onSurface=!1),a.spaceship.position.y<b.designDim.h/2&&(.01>Math.abs(a.spaceship.velocity.x)&&(l=b.GAME_STATES.GAME_PAUSED,setTimeout(function(){l=b.GAME_STATES.GAME_ON;a.spaceship.levelUp()},700)),a.spaceship.position.x-
a.spaceship.getBounds().width/2<a.level250.position.x-a.level250.width/2&&(a.spaceship.onSurface=!1),a.spaceship.position.x+a.spaceship.getBounds().width/2>a.level250.position.x+a.level250.width/2&&(a.spaceship.onSurface=!1))),c=this.minkowskiDifference(f),e=new d(c.position.x-c.width/2,c.position.y-c.height/2),c=new d(c.position.x+c.width/2,c.position.y+c.height/2),0>=e.x&&0<=c.x&&0>=e.y&&0<=c.y&&(p.clearRect(0,0,m.width,m.height),p.drawImage(this.texture.baseTexture.source,0,0),E=p.getImageData(0,
0,this.getBounds().width,this.getBounds().height),p.clearRect(0,0,m.width,m.height),p.drawImage(f.texture.baseTexture.source,0,0),F=p.getImageData(0,0,f.getBounds().width,f.getBounds().height),G(E,this.x,this.y,F,f.x,f.y,!0)&&(this===a.spaceship&&f===a.level250||this===a.level250&&f===a.spaceship)&&a.spaceship.checkPlatformHit(a.level250));this===a.spaceship&&f===a.roller&&(c=this.minkowskiDifference(f),e=new d(c.position.x-c.width/2,c.position.y-c.height/2),c=new d(c.position.x+c.width/2,c.position.y+
c.height/2),0>=e.x&&0<=c.x&&0>=e.y&&0<=c.y&&(p.clearRect(0,0,m.width,m.height),p.drawImage(this.texture.baseTexture.source,0,0),E=p.getImageData(0,0,this.getBounds().width,this.getBounds().height),p.clearRect(0,0,m.width,m.height),p.drawImage(f.texture.baseTexture.source,0,0),F=p.getImageData(0,0,f.getBounds().width,f.getBounds().height),G(E,this.x,this.y,F,f.x,f.y,!0)&&this===a.spaceship&&f===a.roller&&(ttHighScoreManager.saveTop10(u),l=b.GAME_STATES.START_START_SCREEN,q.gameOver.audio.play())))};
PIXI.Sprite.prototype.calculateAcceleration=function(){var a=0,c=0;1==this.affectedByGravity&&(this.onSurface||(c=this.gravityFactor?c+b.physics.gravityOrig*this.gravityFactor:c+b.physics.gravityOrig));0!=this.temporaryAccelerationImpulseX&&(a+=this.temporaryAccelerationImpulseX,this.temporaryAccelerationImpulseX=0);0!=this.temporaryAccelerationImpulseY&&(c+=this.temporaryAccelerationImpulseY*Math.cos(this.rotation),a+=-2*this.temporaryAccelerationImpulseY*Math.sin(this.rotation),this.temporaryAccelerationImpulseY=
0);this.acceleration=new d(this.acceleration.x+a*e.timeDiffNowMs,this.acceleration.y+c*e.timeDiffNowMs);this.acceleration.x>b.physics.limitAccelerationXMax&&(this.acceleration=new d(b.physics.limitAccelerationXMax,this.acceleration.y));this.acceleration.x<b.physics.limitAccelerationXMin&&(this.acceleration=new d(b.physics.limitAccelerationXMin,this.acceleration.y));this.acceleration.y>b.physics.limitAccelerationYMax&&(this.acceleration=new d(this.acceleration.x,b.physics.limitAccelerationYMax));this.acceleration.y<
b.physics.limitAccelerationYMin&&(this.acceleration=new d(this.acceleration.x,b.physics.limitAccelerationYMin))};PIXI.Sprite.prototype.calculateVelocity=function(){var c=0,g=0;0!=this.temporaryVelocityImpulseX&&(c=this.temporaryVelocityImpulseX);0!=this.temporaryVelocityImpulseY&&(g=this.temporaryVelocityImpulseY);this.velocity.add(new d(this.acceleration.x*e.timeDiffNowMs+c,this.acceleration.y*e.timeDiffNowMs+g));this.acceleration=new d(0,this.acceleration.y);0!=this.tempVelocityImpulseY&&(this.temporaryVelocityImpulseY=
0);0!=this.tempVelocityImpulseX&&(this.temporaryVelocityImpulseX=0);this.velocity.x>b.physics.limitVelocityX&&(this.velocity=new d(b.physics.limitVelocityX,this.velocity.y));this.velocity.x<-1*b.physics.limitVelocityX&&(this.velocity=new d(-1*b.physics.limitVelocityX,this.velocity.y));this.velocity.y>b.physics.limitVelocityY&&(this.velocity=new d(this.velocity.x,b.physics.limitVelocityY));this.velocity.y<-1*b.physics.limitVelocityY&&(this.velocity=new d(this.velocity.x,-1*b.physics.limitVelocityY));
this===a.roller&&.2>Math.abs(this.velocity.x)&&(this.velocity=0>this.velocity.x?new d(-.2,this.velocity.y):new d(.2,this.velocity.y))};PIXI.Sprite.prototype.resetAccelerationX=function(){this.acceleration.x=new d(0,this.acceleration.y)};PIXI.Sprite.prototype.resetAccelerationY=function(){this.acceleration.y=new d(this.acceleration.x,0)};PIXI.Sprite.prototype.resetAcceleration=function(){this.resetAccelerationX();this.resetAccelerationY()};PIXI.Sprite.prototype.resetVelocityX=function(){this.velocity=
new d(0,this.velocity.y)};PIXI.Sprite.prototype.resetVelocityY=function(){this.velocity=new d(this.velocity.x,0)};PIXI.Sprite.prototype.resetVelocity=function(){this.resetVelocityX();this.resetVelocityY()};PIXI.Sprite.prototype.calculatePhysics=function(){this.pastAcceleration=new d(this.acceleration.x,this.acceleration.y);this.calculateAcceleration();this.pastVelocity=new d(this.velocity.x,this.velocity.y);this.calculateVelocity();this.pastPosition=new d(this.position.x,this.position.y);this.setPhysicsCalculatedPosition(new d(this.position.x+
this.velocity.x*e.timeDiffNowMs,this.position.y+this.velocity.y*e.timeDiffNowMs))};PIXI.Sprite.prototype.setPhysicsCalculatedPosition=function(a){this.position.x=a.x;this.position.y=a.y};PIXI.Sprite.prototype.minkowskiDifference=function(a){if(a!==this){var b=new d(this.position.x-this.width/2,this.position.y-this.height/2),c=new d(a.position.x+a.width/2,a.position.y+a.height/2),e=new d(this.width,this.height);a=new d(a.width,a.height);b=new d(b.x-c.x,b.y-c.y);e=new d(e.x+a.x,e.y+a.y);c=new PIXI.Sprite;
c.width=e.x;c.height=e.y;c.position.x=b.x+c.width/2;c.position.y=b.y+c.height/2;return c}};PIXI.Sprite.prototype.checkPlatformHit=function(b){1E4==this.bounce&&(this.bounce=0);this===a.roller&&a.roller.position.y+a.roller.height/2>=a.level250.position.y-a.level250.height/2&&!this.onSurface&&(a.roller.position.x>a.level250.position.x-a.level250.width/2&&a.roller.position.x<a.level250.position.x+a.level250.width/2?(a.roller.position.x=a.roller.position.x,a.roller.position.y=a.level250.y-a.level250.height/
2-a.roller.getBounds().height/2,a.roller.onSurface=!0,a.roller.acceleration=new d(a.roller.acceleration.x,0),a.roller.velocity=new d(a.roller.velocity.x,0)):(a.roller.position.x<a.level250.position.x-a.level250.width/2&&(a.roller.position=new d(a.roller.position.x,a.level250.position.y-a.level250.height/2-a.roller.height/2),a.roller.velocity=new d(-1*(Math.abs(a.roller.velocity.x)+1E-4),0)),a.roller.position.x>a.level250.position.x+a.level250.width/2&&(a.roller.position=new d(a.roller.position.x,
a.level250.position.y-a.level250.height/2-a.roller.height/2),a.roller.velocity=new d(1*(Math.abs(a.roller.velocity.x)+1E-4),0))),a.roller.platformHitPlayed||(q.gPomp.audio.play(),a.roller.platformHitPlayed=!0));this===a.spaceship&&(0==a.spaceship.bounce?(a.spaceship.position.x=a.spaceship.position.x,a.spaceship.position.y=a.level250.position.y-a.level250.height/2-a.spaceship.height/2-.1,a.spaceship.onSurface=!0,a.spaceship.acceleration=new d(a.spaceship.acceleration.x,0),a.spaceship.velocity=new d(a.spaceship.velocity.x,
0)):(a.spaceship.velocity=new d(a.spaceship.velocity.x,-1*a.spaceship.bounce*a.spaceship.velocity.y),a.spaceship.rotation=0,a.spaceship.position.y<a.level250.position.y-a.level250.height/2?(a.spaceship.position.y=a.level250.position.y-a.level250.height/2-a.spaceship.height/2-.1,.1>Math.abs(a.spaceship.velocity.y)?(a.spaceship.position.x=a.spaceship.position.x,a.spaceship.onSurface=!0,a.spaceship.acceleration=new d(a.spaceship.acceleration.x,0),a.spaceship.velocity=new d(a.spaceship.velocity.x,0)):
a.spaceship.rotation=0):a.spaceship.position.y=a.level250.position.y+a.level250.height/2+a.spaceship.height/2+.1))};PIXI.Sprite.prototype.checkBottomHit=function(c){1E4==this.bounce&&(this.bounce=0);c=b.nonGameArea;c.x=b.nonGameArea.x;c.y=b.nonGameArea.y;c.w=b.designDim.w;c.h=b.designDim.h-b.nonGameArea.h;this.position.y+this.getBounds().height/2>=c.y&&(0<this.rotation&&this.rotation<Math.PI/180*45&&(this.rotation=0),0>this.rotation&&this.rotation>Math.PI/180*-45&&(this.rotation=0),this.rotation>
Math.PI/180*60&&this.rotation<Math.PI/180*180&&(this.rotation=Math.PI/180*60),this.rotation<Math.PI/180*-60&&this.rotation>Math.PI/180*-180&&(this.rotation=Math.PI/180*-60),this.onSurface?this.position.y=c.y-this.height/2-.1:(this.position.x=this.position.x,this.position.y=c.y-Math.floor(this.height/2),this.velocity=new d(this.velocity.x,-1*this.bounce*this.velocity.y),0==this.bounce?(this.onSurface=!0,this.acceleration=new d(this.acceleration.x,0),this.velocity=new d(this.velocity.x,0)):.1>Math.abs(this.velocity.y)&&
(this.onSurface=!0,this.acceleration=new d(this.acceleration.x,0),this.velocity=new d(this.velocity.x,0),this.rotation=0),this===a.roller&&q.gPomp.audio.play()))}})(window.tt=window.tt||{},jQuery);